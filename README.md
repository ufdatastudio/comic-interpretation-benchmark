...
## Structure
Scripts in the `src` directory are used to call Hugging Face (HF) models, show them the page image data in `comics`, and calculate metrics. See the `src` and `comics` READMEs for more information.
